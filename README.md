...
1. สร้างโปรเจกต์ <br> uv init --no-progress --no-readme --no-pin-python --name repl_nix_workspace
2. ติดตั้ง Library <br> uv add passlib fastapi uvicorn python-jose bcrypt python-multipart jinja2 jose starlette
3. ตั้งค่าให้ Library Passlib แมทช์กับ Bcrypt <br> pip uninstall -y bcrypt pip install -U "passlib==1.7.4" "bcrypt==4.0.1"
4. กดปุ่มรัน
